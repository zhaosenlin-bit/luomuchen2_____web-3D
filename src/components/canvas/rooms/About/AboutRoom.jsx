...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: '骆沐辰 MUCHEN', subtitle: '小创客 · Vibe Coding · 宇宙探索' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: '比赛荣誉', subtitle: '2025 宜昌锦标赛冠军 · 电教馆信息素养活动' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: '成长路线', subtitle: 'Vibe Coding · 网站 · 3D · 游戏 · 发布' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: '能力清单', subtitle: '网站开发 / 3D / 游戏 / 比赛讲解 / Prompt' },
];
    ...
    return (
        <group ref={roomRef} position={[0, 0, -25]}>
            {!isWarmup && (
                <PositionalAudio
                    ref={audioRef}
                    url="/luomuchen2_____web-3D/sounds/szumwiatru.mp3"
