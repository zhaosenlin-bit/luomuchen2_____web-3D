...
const Doodles = () => {
    ...
    const textures = useTexture({
        paperBall: '/cartoon/textures/corridor/decorations/paper_ball.webp',
        paperAirplane: '/cartoon/textures/corridor/decorations/paper_airplane.webp',
        pencil: '/cartoon/textures/corridor/decorations/pencil.webp',
        coffeeCup: '/cartoon/textures/corridor/decorations/coffee_cup.webp',
        // Tech-themed additions
        coffeeDebug: '/cartoon/textures/corridor/decorations/coffee_debug.webp',
        ideaProcess: '/cartoon/textures/corridor/decorations/idea_process.webp',
        whileTrueLoop: '/cartoon/textures/corridor/decorations/while_true_loop.webp',
    });
