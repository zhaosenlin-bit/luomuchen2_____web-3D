...
export const ACHIEVEMENTS = {
    ...
    practice_browse: { id: 'practice_browse', label: '点击卡片查看学习领域', title: '探索家' }
};
...
export const AchievementsProvider = ({ children }) => {
    ...
    const [completed, setCompleted] = useState(() => {
        try {
            const saved = localStorage.getItem('muchen_achievements');
            if (saved) {
    ...
    useEffect(() => {
        ...
        localStorage.setItem('muchen_achievements', JSON.stringify(toSave));
    }, [completed]);
