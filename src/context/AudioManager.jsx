...
export const AudioProvider = ({ children }) => {
    ...
    const play = useCallback((soundName, { loop = false, volume = 1.0 } = {}) => {
        ...
        const soundPaths = {
            'pencil': '/luomuchen2_____web-3D/sounds/papersound.mp3',
            'tear': '/luomuchen2_____web-3D/sounds/papersound.mp3',
            'szumwiatru': '/luomuchen2_____web-3D/sounds/szumwiatru.mp3', // Szum wiatru w pokoju About
            'szummiasta': '/luomuchen2_____web-3D/sounds/szummiasta.mp3', // Szum miasta w pokoju The Gallery
            'uchyleniedrzwi': '/luomuchen2_____web-3D/sounds/uchyleniedrzwi.mp3', // Skrzypienie przy najechaniu
            'otwarciedrzwi': '/luomuchen2_____web-3D/sounds/otwarciedrzwi.mp3',   // Otwarcie głównych/bocznych drzwi
            'zamknieciedrzwi': '/luomuchen2_____web-3D/sounds/zamknieciedrzwi.mp3' // Zamykanie drzwi
        };
        const path = soundPaths[soundName] || `/luomuchen2_____web-3D/sounds/${soundName}.mp3`;
