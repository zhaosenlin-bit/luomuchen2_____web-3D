...
const DOOR_TEXTURES = {
    '关于我': '/cartoon/textures/corridor/doors/drzwiabout.webp',
    '教学方向': '/cartoon/textures/corridor/doors/drzwipractice.webp',
    '作品应用': '/cartoon/textures/corridor/doors/drzwiprojekty.webp',
    '创作现场': '/cartoon/textures/corridor/doors/drzwisocial.webp',
    '掠影照片': '/cartoon/textures/corridor/doors/drzwimoments.webp',
    '联系我': '/cartoon/textures/corridor/doors/drzwikontakt.webp',
};

// Painted (colored) variants for brush-stroke reveal on hover
const DOOR_PAINTED_TEXTURES = {
    '关于我': '/cartoon/textures/corridor/doors/drzwiabout_painted.webp',
    '教学方向': '/cartoon/textures/corridor/doors/drzwipractice_painted.webp',
    '作品应用': '/cartoon/textures/corridor/doors/drzwiprojekty_painted.webp',
    '创作现场': '/cartoon/textures/corridor/doors/drzwisocial_painted.webp',
    '掠影照片': '/cartoon/textures/corridor/doors/drzwimoments_painted.webp',
    '联系我': '/cartoon/textures/corridor/doors/drzwikontakt_painted.webp',
};
...
const DoorSection = ({
    ...
    // Load wall texture
    const originalWallTexture = useTexture('/cartoon/textures/corridor/wall_texture.webp');
    ...
    const frameTexture = useTexture('/cartoon/textures/corridor/doors/ramkasingledoors.webp');
    const handleTexture = useTexture('/cartoon/textures/corridor/doors/klamkadodrzwi.webp');
    const handlePaintedTexture = useTexture(isTouch ? dummyTex : '/cartoon/textures/corridor/doors/klamkadodrzwi_painted.webp');
    const doorBackTexture = useTexture('/cartoon/textures/corridor/doors/backsingledoors.webp');
    const arrowTexture = useTexture('/cartoon/textures/corridor/strzalka.webp');
    ...
    const signTextureUrl = '/cartoon/textures/corridor/pustatabliczka.webp';
...
{/* === DOOR FRAME (textured) === */}
                    ...
                    <group ref={doorRef} position={[doorPivotX, 0, 0.01]}>
                        ...
                        <mesh
                            ...
                            scale={[(side === 'right' && label !== '创作现场') ? -1 : 1, 1, 1]}
                        >
                            <planeGeometry args={[doorWidth, doorHeight]} />
                            <meshBasicMaterial color="#e0e0e0"
                ...
                <PositionalAudio
                    ref={closeAudioRef}
                    url="/cartoon/sounds/zamknieciedrzwi.mp3"
                    distanceModel="exponential"
                    rolloffFactor={DOOR_AUDIO_SETTINGS.rolloff}
                    refDistance={DOOR_AUDIO_SETTINGS.distance}
                    loop={false}
