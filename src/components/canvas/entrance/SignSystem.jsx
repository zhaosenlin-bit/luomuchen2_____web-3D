...
const SignSystem = (props) => {
    ...
    const signTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/sign_muchen.webp');
    const mountTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/belka.webp');
