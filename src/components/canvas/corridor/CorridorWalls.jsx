...
const CorridorWalls = ({ zStart = 10, length = 80, doorPositions = [], zClip = 100000 }) => {
    ...
    const floorTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/kawalekpodlogi.webp');
    ...
    const ceilingTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/ceiling_texture.webp');
