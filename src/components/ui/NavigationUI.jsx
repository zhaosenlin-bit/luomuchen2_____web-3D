...
const ROOMS = [
    ...
    { id: 'practice', label: '学习领域', x: 50, y: 32 },  // Course path (center top)
    { id: 'gallery', label: '我的作品', x: 43, y: 72 },  // City buildings (bottom left)
    { id: 'studio', label: '概念乐园', x: 57, y: 55 },    // Monitors stack (right side)
    { id: 'moments', label: '每日记录', x: 50, y: 66 },  // Photo wall (center bottom)
                ...
                <div className={`map-panel ${isMenuOpen ? 'open' : ''}`} inert={!isMenuOpen ? true : undefined} ref={mapPanelRef} onKeyDown={handleMapKeyDown} role="dialog" aria-label="Map">
                    ...
                    <div className="map-content-clipped">
                        ...
                        <div className="map-container">
                            ...
                            <img src="/luomuchen2_____web-3D/images/map.webp" alt="房间地图" className="map-image" />

                            {/* Painted Map Overlays */}
                            <img ref={paintedMapsRefs.about} src="/luomuchen2_____web-3D/images/map_about_painted.webp" alt="" className="painted-map-layer" style={{ clipPath: 'polygon(10% 20%, 10% 20%, 10% 55%, 10% 55%)' }} />
                            <img ref={paintedMapsRefs.gallery} src="/luomuchen2_____web-3D/images/map_gallery_painted.webp" alt="" className="painted-map-layer" style={{ clipPath: 'polygon(10% 57%, 10% 57%, 10% 92%, 10% 92%)' }} />
                            <img ref={paintedMapsRefs.contact} src="/luomuchen2_____web-3D/images/map_contact_painted.webp" alt="" className="painted-map-layer" style={{ clipPath: 'polygon(95% 10%, 95% 10%, 95% 35%, 95% 35%)' }} />
                            <img ref={paintedMapsRefs.studio} src="/luomuchen2_____web-3D/images/map_studio_painted.webp" alt="" className="painted-map-layer" style={{ clipPath: 'polygon(85% 41%, 85% 41%, 85% 81%, 85% 81%)' }} />
                            ...
                            <div className="map-room-label practice">学习领域</div>
                            <div className="map-room-label gallery">我的作品</div>
                            <div className="map-room-label studio">概念乐园</div>
                            <div className="map-room-label moments">每日记录</div>
                            ...
                            {ROOMS.map((room) => (
                                <button
                                    ...
                                    title={room.label}
                                >
                                    <img src="/luomuchen2_____web-3D/images/pin-slot.webp" alt="" className="slot-image" />
                                </button>
                            ))}
                            ...
                            >
                                <img src="/luomuchen2_____web-3D/images/pin.webp" alt="当前位置" className="pin-image" />
                            </div>
                        </div>
                    </div>
                </div>
