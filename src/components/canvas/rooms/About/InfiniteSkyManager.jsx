...
const IntroMilestone = ({ z, scrollProgressRef }) => {
    ...
    const avatarTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/textures/about/muchen-avatar.webp');
    ...
    return (
        <group ref={groupRef} position={[0, 0, z]}>
            ...
            <Text
                ...
                fontSize={0.45}
            >
                我正在学 Vibe Coding、网站、3D 和机器人，目标是参加更多比赛。            </Text>
        </group>
    );
};
...
const AWARDS_DATA = {
    featured: {
        ...
        title: '我的作品与荣誉',
        items: [
            { label: '宇宙探索者 · 网站 + 游戏', date: '2026', image: '/luomuchen2_____web-3D/media/apps/cosmic-home.webp', url: '' },
            { label: '我的个人站 · 3D 卡通走廊', date: '2026', image: '/luomuchen2_____web-3D/media/apps/knowledge-base.webp', url: '' },
            { label: '我的 AI 学习知识库', date: '2026-08-10', image: '/luomuchen2_____web-3D/media/apps/knowledge-base.webp', url: '' },
            { label: '世界机器人大赛 · 冠军', date: '2025', image: '/luomuchen2_____web-3D/media/gallery/wrc7.jpg', url: '' },
        ],
        platformConfig: {
            label: '我的荣誉',
            color: '#1a1a1a',
    ...
    sotd: {
        ...
        title: '比赛与荣誉',
        items: [
            { label: '世界机器人大赛 · 2025 宜昌锦标赛 冠军', date: '2025', image: '/luomuchen2_____web-3D/media/gallery/wrc7.jpg', url: '' },
            { label: '电教馆信息素养提升活动 · 心理健康 × 科技', date: '2026', image: '/luomuchen2_____web-3D/media/scenes/ai-classroom-path.jpg', url: '' },
        ],
        platformConfig: {
            label: '荣誉',
            color: '#1a1a1a',
    ...
    sotm: {
        ...
        title: '我的作品',
        items: [
            { label: '宇宙探索者 · 已发布上线', date: '2026', image: '/luomuchen2_____web-3D/media/apps/cosmic-home.webp', url: '' },
            { label: '我的个人站（进行中）', date: '2026', image: '/luomuchen2_____web-3D/media/apps/knowledge-base.webp', url: '' },
        ],
        platformConfig: {
            label: '作品',
            color: '#1a1a1a',
    ...
    other: {
        ...
        title: '下一个小目标',
        items: [
            { label: '参加黑客松和企业比赛', date: '未来', image: '/luomuchen2_____web-3D/media/moments/cosmic-mission.webp', url: '' },
            { label: '把宇宙探索者加上 AI 拟声', date: '未来', image: '/luomuchen2_____web-3D/media/moments/cosmic-3d.webp', url: '' },
        ],
        platformConfig: {
            label: '目标',
            color: '#1a1a1a',
...
const AwardsMilestone = ({ z, scrollProgressRef }) => {
    ...
    // Load textures
    const sotyTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/textures/about/muchen-card-kb.webp');
    const sotdTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/textures/about/muchen-card-champion.webp');
    const sotmTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/textures/about/muchen-card-edu.webp');
    const sotyPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/luomuchen2_____web-3D/textures/about/muchen-card-kb.webp' : '/luomuchen2_____web-3D/textures/about/muchen-card-kb.webp');
    const sotdPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/luomuchen2_____web-3D/textures/about/muchen-card-champion.webp' : '/luomuchen2_____web-3D/textures/about/muchen-card-champion.webp');
    const sotmPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/luomuchen2_____web-3D/textures/about/muchen-card-edu.webp' : '/luomuchen2_____web-3D/textures/about/muchen-card-edu.webp');
    const buttonTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/textures/about/button.webp');
    const buttonPaintedTexture = useLoader(THREE.TextureLoader, isTouch ? '/luomuchen2_____web-3D/textures/about/button.webp' : '/luomuchen2_____web-3D/textures/about/button_painted.webp');
    ...
    return (
        <group ref={groupRef} position={[0, 2, z]}>
            ...
            <Text
                ...
                anchorX="center"
                anchorY="middle"
                font="/luomuchen2_____web-3D/fonts/RubikScribble-Regular.ttf"
            >
                MY AWARDS
            </Text>
...
const JourneyMilestone = ({ z, scrollProgressRef }) => {
    ...
    const uoTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/media/moments/cosmic-3d.webp');
    const freelanceTexture = useLoader(THREE.TextureLoader, '/luomuchen2_____web-3D/media/gallery/wrc7.jpg');
...
const BALLOON_CONFIG = [
    ...
    { texture: '/luomuchen2_____web-3D/textures/about/reactduzybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/reactduzybalon_painted.webp', label: 'React', size: 'large', x: -2.5, y: 2, z: 0.3, phase: 0 },
    { texture: '/luomuchen2_____web-3D/textures/about/threejsduzybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/threejsduzybalon_painted.webp', label: 'Three.js', size: 'large', x: 2.5, y: 2.5, z: 0.2, phase: 1.5 },
    { texture: '/luomuchen2_____web-3D/textures/about/GSAPduzybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/GSAPduzybalon_painted.webp', label: 'GSAP', size: 'large', x: 0, y: 3, z: 0.5, phase: 3 },

    // Medium balloons - scattered around
    { texture: '/luomuchen2_____web-3D/textures/about/JSSREDNIBALON.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/JSSREDNIBALON_painted.webp', label: 'JavaScript', size: 'medium', x: -4, y: 1, z: -0.3, phase: 0.8 },
    { texture: '/luomuchen2_____web-3D/textures/about/csssrednibalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/csssrednibalon_painted.webp', label: 'CSS', size: 'medium', x: 4, y: 1.5, z: -0.2, phase: 2.2 },
    { texture: '/luomuchen2_____web-3D/textures/about/nextjssrednibalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/nextjssrednibalon_painted.webp', label: 'Vite', size: 'medium', x: 0, y: 0.5, z: -0.4, phase: 4 },

    // Small balloons - background accents
    { texture: '/luomuchen2_____web-3D/textures/about/htmlmalybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/htmlmalybalon_painted.webp', label: 'HTML', size: 'small', x: -5.5, y: 2.5, z: -0.8, phase: 1.2 },
    { texture: '/luomuchen2_____web-3D/textures/about/gitmalybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/gitmalybalon_painted.webp', label: 'Git', size: 'small', x: 5.5, y: 3, z: -0.7, phase: 2.8 },
    { texture: '/luomuchen2_____web-3D/textures/about/figmamalybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/figmamalybalon_painted.webp', label: 'TypeScript', size: 'small', x: -3, y: 4.5, z: -0.5, phase: 3.5 },
    { texture: '/luomuchen2_____web-3D/textures/about/firebasemalybalon.webp', paintedTexture: '/luomuchen2_____web-3D/textures/about/firebasemalybalon_painted.webp', label: 'Cloudflare', size: 'small', x: 3.5, y: 4, z: -0.6, phase: 4.5 },
];
    ...
    return (
        ...
        >
            <group ref={innerGroupRef}>
                ...
                <PositionalAudio
                    ref={balloonAudioRef}
                    url="/luomuchen2_____web-3D/sounds/baloonpoop.mp3"
 ...
 */
const KPI_DATA = [
    { value: '01', suffix: '', label: '个 AI 知识库' },
    { value: '02', suffix: '', label: '场比赛与活动' },
    { value: '01', suffix: '', label: '个已发布作品' },
    { value: '05', suffix: '', label: '张概念卡' },
];
