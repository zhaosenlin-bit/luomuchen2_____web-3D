...
const EntranceDoors = ({
    ...
    const frameTexture = useTexture('/luomuchen2_____web-3D/textures/doors/frame_sketch.webp');
    const doorLeftTexture = useTexture('/luomuchen2_____web-3D/textures/doors/door_left_sketch.webp');
    const doorRightTexture = useTexture('/luomuchen2_____web-3D/textures/doors/door_right_sketch.webp');

    // Mobile optimization: Don't load painted textures or handles on phones
    const doorRightPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/luomuchen2_____web-3D/textures/doors/door_right_painted.webp');
    const doorLeftPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/luomuchen2_____web-3D/textures/doors/door_left_painted.webp');
    const handleLeftTexture = useTexture('/luomuchen2_____web-3D/textures/doors/handle_left_sketch.webp');
    const handleLeftPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/luomuchen2_____web-3D/textures/doors/handle_left_painted.webp');
    const handleRightTexture = useTexture('/luomuchen2_____web-3D/textures/doors/handle_right_sketch.webp');
    const handleRightPaintedTexture = useTexture(isMobileDevice ? dummyTex : '/luomuchen2_____web-3D/textures/doors/handle_right_painted.webp');

    // Dynamic textures for mobile
    const doorBackTexture = useTexture(isMobileDevice ? '/luomuchen2_____web-3D/textures/doors/door_back.webp' : '/luomuchen2_____web-3D/textures/doors/door_back_left_sketch.webp');
    const edgeTexture = useTexture(isMobileDevice ? '/luomuchen2_____web-3D/textures/doors/pien_sketch.webp' : '/luomuchen2_____web-3D/textures/doors/pien.webp');

    const bricksTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/wall_bricks_2.webp');
    const stonePathTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/stone-path.webp');
    // const catTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/cat_sketch.webp'); // Old side cat
    const catFrontBodyTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/cat_front_body.webp');
    const windowSketchTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/window_sketch.webp');
    // Use the original hand-drawn greeting figure in the window.
    const avatarWindowTexture = useTexture('/luomuchen2_____web-3D/media/tech-sketches/window-avatar-handdrawn-cutout.png');
    const treeTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/tree_sketch.webp');
    const mouseTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/mouse_hanging.webp');
    const potTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/pot_with_duck.webp');
    const bugTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/bug_sketch.webp');
    const inkSplashTexture = useTexture('/luomuchen2_____web-3D/images/ink-splash.webp');
    const speechBubbleTexture = useTexture('/luomuchen2_____web-3D/textures/entrance/speech_bubble.webp');
    const aiChipSketchTexture = useTexture('/luomuchen2_____web-3D/media/handdrawn-tech/entrance-ai-chip-doodle.png');
    const codeSymbolSketchTexture = useTexture('/luomuchen2_____web-3D/media/handdrawn-tech/entrance-code-badge-doodle.png');
    const neuralNetSketchTexture = useTexture('/luomuchen2_____web-3D/media/handdrawn-tech/entrance-neural-doodle.png');
    const terminalSketchTexture = useTexture('/luomuchen2_____web-3D/media/handdrawn-tech/entrance-terminal-doodle.png');
    const pythonSketchTexture = useTexture('/luomuchen2_____web-3D/media/handdrawn-tech/entrance-python-doodle.png');
    const avatarSketchTexture = useTexture('/luomuchen2_____web-3D/media/handdrawn-tech/entrance-avatar-badge-doodle.png');
