...
const CABIN_SKETCH_URL = '/luomuchen2_____web-3D/fonts/CabinSketch-Regular.ttf';
...
const CorridorDecorations = ({
    ...
    // TEKSTURY DEKORACJI
    // =============================================
    const frameTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/ramkanazdjecieduza.webp');
    const framePaintedTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/ramkanazdjecieduza_painted.webp');
    const standingFrameTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/ramkanazdjeciemala.webp');
    const treeTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/drzewkowdoniczce.webp');
    const grateTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/kratkawentylacyjna.webp');
    const flowerTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/kwiatekwdoniczce.webp');

    // --- Ceiling Lights (punkty 鑹iat鑹俛) ---
    // Tekstury lamp
    const lampGrilleTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/kratanalampy.webp');
    // lampGrilleTexture.wrapS = lampGrilleTexture.wrapT = THREE.RepeatWrapping; 
    // lampGrilleTexture.repeat.set(1, 1);

    const lampSideTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/bokilampy.webp');
    ...
    const frames = useMemo(() => [
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-personal-site.png',
        ...
        },
        {
            ...
            y: 0.28,
            id: 'frame-ai-garden',
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-ai-garden.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-code-castle.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-debug-notes.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            signature: '沐辰 · Muchen',
            signatureX: 0,
        ...
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-python-path.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-neural-constellation.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-robot-tutor.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            y: 0.3,
            id: 'frame-data-cloud',
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-data-cloud.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-keyboard-music.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
        {
            ...
            image: '/luomuchen2_____web-3D/media/handdrawn-tech/frame-model-trainer.png',
            imageWidth: frameInnerWidth,
            imageHeight: frameInnerHeight,
            offsetFromWall: 0.1
        },
    ...
    // STOLIK (TABLE)
    // =============================================
    const woodTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/texturadrewnadonozekbiurka.webp');
    const tableTopTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/gorastolika.webp');

    // Tekstury szafki
    const cabinetFrontTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/szafkaprzod.webp');
    const cabinetRestTexture = useTexture('/luomuchen2_____web-3D/textures/corridor/szafkaprzodgora.webp');
