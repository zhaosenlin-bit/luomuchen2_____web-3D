...
const RUBIK_SCRIBBLE_URL = '/luomuchen2_____web-3D/fonts/RubikScribble-Regular.ttf';
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    const taglineWords = useMemo(() => [
        { text: '用AI', baseX: -1.35, splitDir: -1.0, delay: 0 },
        { text: '创造', baseX: 0, splitDir: 0, delay: 0 },
        { text: '世界', baseX: 1.35, splitDir: 1.0, delay: 0 },
    ], []);
