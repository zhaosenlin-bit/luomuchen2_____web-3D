...
const SegmentDoors = ({
    ...
    const frameTexture = useTexture('/cartoon/textures/corridor/doors/frame_sketch.webp');
    const doorLeftTexture = useTexture('/cartoon/textures/corridor/doors/doorrleft.webp');
    const doorRightTexture = useTexture('/cartoon/textures/corridor/doors/dorright.webp');
    const handleLeftTexture = useTexture('/cartoon/textures/corridor/doors/handle_left_sketch.webp');
    const handleRightTexture = useTexture('/cartoon/textures/corridor/doors/handle_right_sketch.webp');
    const doorBackTexture = useTexture('/cartoon/textures/corridor/doors/door_back.webp');
    const edgeTexture = useTexture('/cartoon/textures/corridor/doors/pien.webp');
    const wallTexture = useTexture('/cartoon/textures/corridor/wall_texture.webp');

    wallTexture.wrapS = wallTexture.wrapT = THREE.RepeatWrapping;

    // Baseboard texture (1582x94 px)
    const baseboardTexSrc = useTexture('/cartoon/textures/corridor/texturadoprogow.webp');
    ...
    // Wall Decorations
    const whileTrueTexture = useTexture('/cartoon/textures/corridor/decorations/while_true_loop.webp');
    const coffeeTexture = useTexture('/cartoon/textures/corridor/decorations/coffee_debug.webp');
    const ideaTexture = useTexture('/cartoon/textures/corridor/decorations/idea_process.webp');
