...
const MonitorBlock = memo(({ item, meshRef, isSelected, onMonitorClick, disabled, paintOnBeforeCompile, paintUniforms }) => {
    ...
    const frontTextureUrl = item.frontTexture || (
        isBlogMonitor ? '/cartoon/textures/studio/monitor_front.webp' :
            isTvMonitor ? '/cartoon/textures/studio/tv_front.webp' :
    ...
    const paintedFrontTextureUrl = isTouch ? dummyTex : (item.paintedFrontTexture || (
        isBlogMonitor ? '/cartoon/textures/studio/monitor_front_painted.webp' :
            isTvMonitor ? '/cartoon/textures/studio/tv_front_painted.webp' :
    ...
    const monitorBack = useLoader(TextureLoader, '/cartoon/textures/studio/monitor_back.webp');
    const monitorTop = useLoader(TextureLoader, '/cartoon/textures/studio/monitor_top.webp');
    const monitorBottom = useLoader(TextureLoader, '/cartoon/textures/studio/monitor_bottom.webp');
    const monitorLeft = useLoader(TextureLoader, '/cartoon/textures/studio/monitor_left.webp');
    const monitorRight = useLoader(TextureLoader, '/cartoon/textures/studio/monitor_right.webp');
    const monitorBackPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/monitor_back_painted.webp');
    const monitorTopPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/monitor_top_painted.webp');
    const monitorBottomPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/monitor_bottom_painted.webp');
    const monitorLeftPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/monitor_left_painted.webp');
    const monitorRightPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/monitor_right_painted.webp');

    // Load TV textures (YouTube) - shell + painted
    const tvBack = useLoader(TextureLoader, '/cartoon/textures/studio/tv_back.webp');
    const tvTop = useLoader(TextureLoader, '/cartoon/textures/studio/tv_top.webp');
    const tvBottom = useLoader(TextureLoader, '/cartoon/textures/studio/tv_bottom.webp');
    const tvSide = useLoader(TextureLoader, '/cartoon/textures/studio/tv_side.webp');
    const tvBackPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/tv_back_painted.webp');
    const tvTopPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/tv_top_painted.webp');
    const tvBottomPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/tv_bottom_painted.webp');
    const tvSidePainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/tv_side_painted.webp');

    // Load Phone textures (TikTok) - shell + painted
    const phoneBack = useLoader(TextureLoader, '/cartoon/textures/studio/phone_back.webp');
    const phoneSide = useLoader(TextureLoader, '/cartoon/textures/studio/phone_side.webp');
    const phoneBackPainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/phone_back_painted.webp');
    const phoneSidePainted = useLoader(TextureLoader, isTouch ? dummyTex : '/cartoon/textures/studio/phone_side_painted.webp');
