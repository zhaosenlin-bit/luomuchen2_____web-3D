...
const PaperSceneBackground = () => {
  ...
  const texture = useTexture('/luomuchen2_____web-3D/textures/paper-texture.webp');
...
function DocumentMetaBridge() {
  ...
  // Deep linking: if user lands on e.g. /luomuchen2_____web-3D/gallery, auto-teleport after scene loads
  useEffect(() => {
