...
const FONT_PATH = '/cartoon/fonts/CabinSketch-Regular.ttf';
...
const MessagePaper = ({ position = [0, 0.05, 2], onSend }) => {
    ...
    // Load textures
    const paperTexture = useTexture('/cartoon/textures/contact/paper_form.webp');
    const buttonTexture = useTexture('/cartoon/textures/contact/send_button.webp');
