...
const Door = ({
    ...
    const textureMap = useTexture(`/luomuchen2_____web-3D/textures/corridor/doors/drzwi${type}.webp`);
    const isTouch = isTouchDevice();
    const dummyTex = 'data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7';
    const paintedColorMap = useTexture(isTouch ? dummyTex : `/luomuchen2_____web-3D/textures/corridor/doors/drzwi${type}_painted.webp`);
    // Frame
    const frameMap = useTexture(`/luomuchen2_____web-3D/textures/corridor/doors/ramkasingledoors.webp`);
